...
export const SkillInputSchema = z
  .object({
    ...
    ohlcv_weekly: z.array(OhlcvBarSchema).optional(),
    ohlcv_monthly: z.array(OhlcvBarSchema).optional(),
    market_index: z.array(OhlcvBarSchema).optional(),
    market_index_secondary: z.array(OhlcvBarSchema).optional(),
